...
/* This function calculates the number of days in the month */
function daysInMonth(calDate) {
   // Array of the days in each month
   var dayCount = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

   // Extract the four digit yeat and month value
   var thisYear = calDate.getFullYear();
   var thisMonth = calDate.getMonth();

   // Revise the days in February for leaps years
   if (thisYear % 4 === 0) {
...
function calDays(calDate) {
   ...
   var hightlightDay = calDate.getDate();
